...
{
    size_t num_pages =
        (reserved_size + Page::NORMAL_PAGE_SIZE - 1) /
        Page::NORMAL_PAGE_SIZE;
...
Page* Chunk::allocate_block(size_t order)
{
...
Page* Chunk::validate(void* ptr)
{
    ...
    size_t idx = (addr - base_addr) / Page::NORMAL_PAGE_SIZE;
